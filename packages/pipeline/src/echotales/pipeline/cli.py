...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_render.add_argument(
        "--image-engine", default="stub", choices=["stub", "sdxl", "manga", "illustrious", "gemini", "openrouter"],
    ...
    pe_ref.add_argument(
        "--engine", default="stub", choices=["stub", "sdxl", "manga", "illustrious", "gemini", "openrouter"],
